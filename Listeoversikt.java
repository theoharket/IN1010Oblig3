...
Liste<BlaaResept> BlaaResepter = new Lenkeliste<BlaaResept>();
...
Liste<Lege> legerSomHarSkrevetNarkotisk = new Lenkeliste<Lege>();
Liste<Pasient> pasienterMedNarkotiskResept = new Lenkeliste <Pasient>();
...
public void Innlesing(String filnavn){
  ...
  while(filleser.hasNextLine()){
    ...
    for(int i = ResepterPosisjon+1; i < ferdiglestListe.size(); i++){
      ...
      //Disse forløkkene finner legen i enten spesialist eller lege listen.
